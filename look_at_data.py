...
# TODO make to 5 categories with 0 or 1 as value
...
# TODO make 5 different columns with 0 or 1
for dataset in combine:
...
train_data = train_df.sample(frac=train_set_frac)
val_data = train_df.loc[~train_df.index.isin(train_data)]
